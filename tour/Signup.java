...
public class Signup extends JFrame implements ActionListener{
	...
	contentPane.add(lblSecurityQuestion);
      ...
      ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("image/signup.png"));
    ...
    public void actionPerformed(ActionEvent ae){
		...
		textField_3.setText("");
            ...
            if(ae.getSource() == b2){
                ...
                JOptionPane.showMessageDialog(null, "You cannot use the Existing Username or same Password which is already use. ");
                   System.out.print("You cannot use the Existing Username. ");
